# importing the needed library for this project
...
st.sidebar.header('One to One Ventures')
...
if selection == 'Business Snapshot':
    st.sidebar.write('Summary of Montly Transactions')
    ...
    with col1:
        # Monthly revenue
        st.write("Monthly Revenue Overview")
    ...
    with col2:
        ...
        st.write("Monthly Items Sold Overview")
    ...
    with col5:
        st.write("Best Countries (Revenue)")
    ...
    with col6:
        st.write("Worst Countries (Revenue)")
        ...
        plt.title('Worst performing Countries')
        st.pyplot(plt)

    # New vs Existing Users
    st.write("New vs Existing Users")
    ...
    st.sidebar.write('Detailed Monthly Transaction Insight')
    st.subheader('Display data')
    st.write(df.head(5))
    # shape of data
...
<p class="grey-text text-lighten-4">November 2021 Cohort</p>
</div>
...
<div class="container">
Practical by <a class="white-text text-lighten-3" href="https://africadataschool.com/">Student JSA </a><br/>
...
if selection == 'About':
    st.sidebar.write('First Streamlit Pratical')
    st.header("About App")
